...
wire full = wr_ptr_gray_reg == {~rd_ptr_gray_sync2_reg[ADDR_WIDTH:ADDR_WIDTH-1], rd_ptr_gray_sync2_reg[ADDR_WIDTH-2:0]};
...
always @* begin
    ...
    if (~rd_rst_sync3_reg && ~empty && (~mem_read_data_valid_reg || ~rd_axis_vld_reg || rd_axis_rdy)) begin
        read = 1'b1;
        mem_read_data_valid_next = 1'b1;
        rd_ptr_next = rd_ptr_reg + 1;
        rd_ptr_gray_next = rd_ptr_next ^ (rd_ptr_next >> 1);
    end else if (~rd_axis_vld_reg || rd_axis_rdy) begin
