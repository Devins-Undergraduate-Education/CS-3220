...
bool Vtb_axi4_ram___024root___eval_phase__act(Vtb_axi4_ram___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtb_axi4_ram__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_axi4_ram___024root___eval_phase__act\n"); );
    // Init
...
bool Vtb_axi4_ram___024root___eval_phase__nba(Vtb_axi4_ram___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtb_axi4_ram__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_axi4_ram___024root___eval_phase__nba\n"); );
    // Init
...
void Vtb_axi4_ram___024root___eval(Vtb_axi4_ram___024root* vlSelf) {
    ...
    while (__VnbaContinue) {
        ...
        while (vlSelf->__VactContinue) {
            ...
            if (Vtb_axi4_ram___024root___eval_phase__act(vlSelf)) {
                vlSelf->__VactContinue = 1U;
            }
        }
        if (Vtb_axi4_ram___024root___eval_phase__nba(vlSelf)) {
            __VnbaContinue = 1U;
        }
    }
}
