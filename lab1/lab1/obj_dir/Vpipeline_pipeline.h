...
class alignas(VL_CACHE_LINE_BYTES) Vpipeline_pipeline final : public VerilatedModule {
  public:
    ...
    CData/*0:0*/ __PVT__my_DE_stage__DOT__writes_rd_instr;
    ...
    CData/*0:0*/ __PVT__my_AGEX_stage__DOT__rd_mem_AGEX;
    CData/*0:0*/ __PVT__my_AGEX_stage__DOT__wr_mem_AGEX;
    CData/*0:0*/ __PVT__my_AGEX_stage__DOT__is_branch_AGEX;
    CData/*0:0*/ __PVT__my_AGEX_stage__DOT__br_taken_AGEX;
    CData/*7:0*/ __PVT__my_MEM_stage__DOT__byte_data_MEM;
    SData/*15:0*/ __PVT__my_MEM_stage__DOT__halfword_data_MEM;
    ...
    VlWide<7>/*206:0*/ __PVT__my_AGEX_stage__DOT__AGEX_latch;
    ...
    IData/*31:0*/ __PVT__my_MEM_stage__DOT__store_mask_MEM;
    IData/*31:0*/ __PVT__my_MEM_stage__DOT__store_data_aligned_MEM;
