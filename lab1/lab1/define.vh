...
// address space is m 0x00000000 to 0x000fffff
  ...
  `define IDMEMINITFILE "/mnt/c/Users/devin/OneDrive/Documents/Georgia_Tech/CS3220/lab1/lab1/test/part1/test5.mem"
...
/** TODO: please update the following define with your own values */ 
 ...
 `define FE_latch_WIDTH  (1 + `INSTBITS+`DBITS+ `DBITS + `DBITS)
  ...
  `define AGEX_latch_WIDTH   (1 + `INSTBITS+`DBITS+ `IOPBITS + `DBITS + `DBITS + `DBITS + `DBITS + 1 + 1 + 1 + `REGNOBITS)
  `define MEM_latch_WIDTH    (1 + `INSTBITS+`DBITS+ `IOPBITS + `DBITS + `DBITS + `DBITS + 1 + 1 + `REGNOBITS) 
