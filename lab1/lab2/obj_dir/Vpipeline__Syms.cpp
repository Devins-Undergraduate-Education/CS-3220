    ...
    , TOP__pipeline__my_WB_stage{this, Verilated::catName(namep, "pipeline.my_WB_stage")}
{
    ...
    for (int __Vfinal = 0; __Vfinal < 2; ++__Vfinal) {
        __Vscope_pipeline__my_AGEX_stage.varInsert(__Vfinal,"bp_branch_count", &(TOP__pipeline__my_AGEX_stage.bp_branch_count), false, VLVT_UINT64,VLVD_NODIR|VLVF_PUB_RW,1 ,63,0);
        __Vscope_pipeline__my_AGEX_stage.varInsert(__Vfinal,"bp_correct_count", &(TOP__pipeline__my_AGEX_stage.bp_correct_count), false, VLVT_UINT64,VLVD_NODIR|VLVF_PUB_RW,1 ,63,0);
