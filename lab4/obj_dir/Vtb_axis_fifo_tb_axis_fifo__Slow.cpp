...
Vtb_axis_fifo_tb_axis_fifo::Vtb_axis_fifo_tb_axis_fifo(Vtb_axis_fifo__Syms* symsp, const char* v__name)
...
Vtb_axis_fifo_tb_axis_fifo::~Vtb_axis_fifo_tb_axis_fifo() {
}
