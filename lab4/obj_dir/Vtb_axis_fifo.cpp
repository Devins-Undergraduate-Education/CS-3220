...
void Vtb_axis_fifo::prepareClone() const { contextp()->prepareClone(); }
void Vtb_axis_fifo::atClone() const {
...
void Vtb_axis_fifo___024root__trace_decl_types(VerilatedVcd* tracep);
...
VL_ATTR_COLD static void trace_init(void* voidSelf, VerilatedVcd* tracep, uint32_t code) {
    ...
    Vtb_axis_fifo___024root__trace_decl_types(tracep);
