...
bool Vtb_axis_fifo___024root___eval_phase__ico(Vtb_axis_fifo___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtb_axis_fifo__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_axis_fifo___024root___eval_phase__ico\n"); );
    // Init
...
bool Vtb_axis_fifo___024root___eval_phase__act(Vtb_axis_fifo___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtb_axis_fifo__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_axis_fifo___024root___eval_phase__act\n"); );
    // Init
...
bool Vtb_axis_fifo___024root___eval_phase__nba(Vtb_axis_fifo___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtb_axis_fifo__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_axis_fifo___024root___eval_phase__nba\n"); );
    // Init
...
void Vtb_axis_fifo___024root___eval(Vtb_axis_fifo___024root* vlSelf) {
    ...
    while (__VicoContinue) {
        ...
        __VicoContinue = 0U;
        if (Vtb_axis_fifo___024root___eval_phase__ico(vlSelf)) {
            __VicoContinue = 1U;
        }
    ...
    while (__VnbaContinue) {
        ...
        while (vlSelf->__VactContinue) {
            ...
            if (Vtb_axis_fifo___024root___eval_phase__act(vlSelf)) {
                vlSelf->__VactContinue = 1U;
            }
        }
        if (Vtb_axis_fifo___024root___eval_phase__nba(vlSelf)) {
            __VnbaContinue = 1U;
        }
    }
}
