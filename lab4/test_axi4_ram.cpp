// DESCRIPTION:  simulation of tb_axi4_ram 
//======================================================================
#include <iostream>

// Include common routines
#include <verilated.h>
// Include model header, generated from Verilating "tb_axi4_ram.v"
...
int main(int argc, char** argv, char** env) {
    ...
    Vtb_axi4_ram* dut = new Vtb_axi4_ram();
    int exitcode = 0;
    ...
    while (timestamp < RUN_CYCLES) {      
        ...
        if (clk_transition && dut->clk) {
            ...
            correct_vld = dut->tb_axi4_ram->correct_V_ap_vld;

            if (correct_vld) {
                if (dut->tb_axi4_ram->correct_V == 0) {
...
#ifdef DPRINTF
    std::cout << "Cycles=" << (timestamp) << std::endl; 
#endif
