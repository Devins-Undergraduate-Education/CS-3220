...
class alignas(VL_CACHE_LINE_BYTES) Vpipeline_pipeline final : public VerilatedModule {
  public:
    ...
    CData/*0:0*/ __PVT__my_FE_stage__DOT__pht_used_FE;
    ...
    SData/*9:0*/ __PVT__my_FE_stage__DOT__bhr;
    SData/*9:0*/ __PVT__my_FE_stage__DOT__pht_index_FE;
    SData/*13:0*/ __Vdlyvdim0__my_MEM_stage__DOT__dmem__v0;
    IData/*31:0*/ __PVT__cycle_count;
    VlWide<6>/*171:0*/ __PVT__my_FE_stage__DOT__FE_latch;
    ...
    IData/*31:0*/ __PVT__my_FE_stage__DOT__next_pc_FE;
    VlWide<9>/*283:0*/ __PVT__my_DE_stage__DOT__DE_latch;
    IData/*31:0*/ __PVT__my_DE_stage__DOT__in_use_regs;
    IData/*31:0*/ my_DE_stage__DOT____VdfgExtracted_h7117cccf__0;
    VlWide<6>/*172:0*/ __PVT__my_MEM_stage__DOT__MEM_latch;
    VlWide<6>/*171:0*/ __Vdly__my_FE_stage__DOT__FE_latch;
    IData/*31:0*/ __Vdlyvval__my_MEM_stage__DOT__dmem__v0;
    QData/*63:0*/ __PVT__my_FE_stage__DOT__btb_valid;
    VlUnpacked<IData/*31:0*/, 16384> __PVT__my_FE_stage__DOT__imem;
    VlUnpacked<CData/*1:0*/, 1024> __PVT__my_FE_stage__DOT__pht;
    VlUnpacked<IData/*31:0*/, 64> __PVT__my_FE_stage__DOT__btb_target;
    VlUnpacked<IData/*23:0*/, 64> __PVT__my_FE_stage__DOT__btb_tag;
