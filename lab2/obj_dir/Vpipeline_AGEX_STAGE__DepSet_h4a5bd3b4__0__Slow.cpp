...
VL_ATTR_COLD void Vpipeline_AGEX_STAGE___ctor_var_reset(Vpipeline_AGEX_STAGE* vlSelf) {
    ...
    VL_RAND_RESET_W(284, vlSelf->__PVT__from_DE_latch);
    VL_RAND_RESET_W(175, vlSelf->__PVT__AGEX_latch_out);
    VL_RAND_RESET_W(112, vlSelf->__PVT__from_AGEX_to_FE);
    vlSelf->__PVT__from_AGEX_to_DE = VL_RAND_RESET_I(1);
    VL_RAND_RESET_W(175, vlSelf->__PVT__AGEX_latch);
    vlSelf->__PVT__actual_taken_AGEX = VL_RAND_RESET_I(1);
    vlSelf->__PVT__resolved_next_pc_AGEX = VL_RAND_RESET_I(32);
    ...
    vlSelf->__PVT__btb_update_en_AGEX = VL_RAND_RESET_I(1);
    vlSelf->bp_branch_count = VL_RAND_RESET_Q(64);
    vlSelf->bp_correct_count = VL_RAND_RESET_Q(64);
